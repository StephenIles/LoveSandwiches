...
def get_sales_data():
    ...
    via the terminal, which must be a string of 6 numbers serparated
    by commas. The loop will repeatedly request data, until it is valid
    """
    while True:
        print("Please enter sales data from the lastest market.")
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defined as the sales figure subtractes fomr the stock:
